    ...
    if(isset($_GET['q']))
    {
        if($_GET['q'] == 'success'){
            echo"<div class='alert alert-success'>
                <button class='close' data-close='alert'></button> You have successfully entered a new customer! </div>";
        }
        else if($_GET['q'] == 'error')
        {
                echo"<div class='alert alert-danger'>
                <button class='close' data-close='alert'></button>CUSTOMER ALREADY EXISTS </div>";
        }
    }
?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input name="customer_email" type="text" class="form-control" placeholder="Email" /> </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Contact No.
                                                    <span class="required"> * </span>
                                                </label>
                                            <div class="col-md-4">
                                                <input type="text" name="customer_contact" class="form-control" placeholder="CONTACT NO.">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">GST NO
                                                </label>
                                            <div class="col-md-4">
