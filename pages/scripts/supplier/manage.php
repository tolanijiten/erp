...
if(isset($_POST["search"]["value"])){
    $query .=" AND (supplier.supplier_name  like '%".$_POST["search"]["value"]."%' OR supplier.supplier_contact like '%". $_POST['search']['value']."%')"; 
}
...
while($row = mysqli_fetch_assoc($result)){
    ...
    $sub_array[] = "<button class='edit fa fa-pencil btn btn-primary' id='".$row['supplier_id']."' data-toggle='modal' data-target='#editModal'></button>";
