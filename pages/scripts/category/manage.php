...
//require_once("../../../assets/pages/scripts/manage-customer-edit.js")
...
while($row = mysqli_fetch_assoc($result)){
    ...
    $sub_array[] = "<button class='edit fa fa-pencil btn btn-primary' id='".$row['category_id']."' data-toggle='modal' data-target='#editModal'></button>";
