    ...
    if(isset($_GET['q']))
    {
        if($_GET['q'] == 'success'){
            echo"<div class='alert alert-success'>
                <button class='close' data-close='alert'></button> You have successfully entered a new supplier! </div>";
        }
        else if($_GET['q'] == 'error'){
                echo"<div class='alert alert-danger'>
                <button class='close' data-close='alert'></button>SUPPLIER ALREADY EXISTS </div>";
        }
    }
?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input name="supplier_email" type="text" class="form-control" placeholder="Email" /> </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input name="supplier_contact" type="text" class="form-control" placeholder="Contact No" /> </div>
                                                <div class="col-md-4"><label><span class="required"></span></label></div>
                                        </div>
