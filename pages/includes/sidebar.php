            ...
            <div class="page-sidebar-wrapper">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                        ...
                        <li class="nav-item  <?php echo($page=='product'?'open active':'')?>">
                            <a href="javascript:;" class="nav-link nav-toggle">
                                <i class="fa fa-cubes"></i>
                                <span class="title">Product</span>
                                <span class="arrow <?php echo($page=='product' ? 'open':'');?>"></span>
                            </a>
                            <ul class="sub-menu">
                                <li class="nav-item <?php echo($sub_page=='add'?'open':'');?>">
                                    <a href="http://localhost/erp/pages/add-product.php" class="nav-link ">
                                        <span class="title">Add Product</span>
                                    </a>
                                </li>
                                <li class="nav-item <?php echo($sub_page=='manage'?'open':'');?>">
                                    <a href="http://localhost/erp/pages/manage-product.php" class="nav-link ">
                        ...
                        <li class="nav-item <?php echo($page=='customer'?'open active':'')?>">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item <?php echo($sub_page=='add'?'open':'');?> ">
                                    <a href="http://localhost/erp/pages/add-customer.php" class="nav-link ">
                                        <span class="title">Add Customer</span>
                                    </a>
                                </li>
                                <li class="nav-item <?php echo($sub_page=='manage'?'open':'');?>">
                                    <a href="http://localhost/erp/pages/manage-customer.php" class="nav-link ">
                        ...
                        <li class="nav-item <?php echo($page=='category'?'open active':'')?>">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item  <?php echo($sub_page=='add'?'open':'');?>">
                                    <a href="http://localhost/erp/pages/add-category.php" class="nav-link ">
                                        <span class="title">Add Category</span>
                                    </a>
                                </li>
                                <li class="nav-item <?php echo($sub_page=='manage'?'open':'');?> ">
                                    <a href="http://localhost/erp/pages/manage-category.php" class="nav-link ">
                        ...
                        <li class="nav-item <?php echo($page=='supplier'?'open active':'')?>">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item  ">
                                    <a href="http://localhost/erp/pages/add-supplier.php" class="nav-link nav-toggle">
                                        <span class="title">Add Supplier</span>
                                    </a>
                                </li>
                                <li class="nav-item <?php echo($sub_page=='manage'?'open':''); ?>  ">
                                    <a href="http://localhost/erp/pages/manage-supplier.php" class="nav-link nav-toggle">
                        ...
                        <li class="nav-item  ">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item  ">
                                    <a href="http://localhost/erp/pages/add-purchase.php" class="nav-link ">
