...
<span class="required"> * </span>
                            ...
                            <div class="modal-footer">
                                ...
                                <button id="edit_save" type="submit" name="edit_supplier" class="btn btn-primary">Save changes</button>
                            </div>
...
<![endif]-->
    ...
    ?>
    <script>
        toastr["info"]("You Have Successfully Edited Supplier", "Supplier Edit!")
...
toastr.options = {
  ...
  "hideMethod": "fadeOut"
        ...
        //toastr["Success"]("You just successfull edited record","Supplier Edit");
    </script>
    <?php
