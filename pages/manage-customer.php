...
<span class="required"> * </span>
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="customer_address" name="customer_address" class="form-control" placeholder="ADDRESS" /> </div>
                            </div>
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="customer_email" name="customer_email" class="form-control" placeholder="EMAIL" /> </div>
                            </div>
                            
                            <div class="form-group clearfix">
                                <label class="control-label col-md-3">CONTACT NO.<span class="required"> * </span>
</label>
                                <div class="col-md-9">
                                    <input type="text" id="customer_contact" name="customer_contact" class="form-control" placeholder="CONTACT"/> </div>
                            </div>
                            ...
                            <div class="modal-footer">
                                ...
                                <button id="edit_save" type="submit" name="edit_customer" class="btn btn-primary">Save changes</button>
                            </div>
...
<![endif]-->
    ...
    <script src="../assets/pages/scripts/manage-customer-edit.js" type="text/javascript"></script>
    ...
    <script>
        ...
        toastr["info"]("You Have Successfully Edited Customer", "Customer Edit!");
...
toastr.options = {
  ...
  "hideMethod": "fadeOut"
        ...
        //toastr["Success"]("You just successfull edited record","Customer Edit");
    </script>
    <?php
    ...
    <?php
    if(isset($_SESSION['status']) && $_SESSION['status'] == CUSTOMER_DELETE_SUCCESS){
    
    ?>
    <script>
        
        toastr["info"]("You Have Successfully Deleted Customer", "Customer Edit!");
toastr.options = {
  "closeButton": true,
  "debug": false,
  "newestOnTop": true,
